...
export default function MaldivesList() {

  const PortBlair = holidayPackages.filter(E => E.packageName === 'Enjoy An Island Getaway With Our Maldives Honeymoon Package')
  ...
  const Havelock = holidayPackages.filter(E => E.packageName === 'Discover Our Beautiful 4 Nights 5 Days Maldives Family Tour Packages')
